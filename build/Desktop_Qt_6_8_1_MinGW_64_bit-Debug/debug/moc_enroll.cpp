...
namespace {
struct qt_meta_tag_ZN6enrollE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN6enrollE = QtMocHelpers::stringData(
    "enroll",
    "done",
    "",
    "closed",
...
Q_CONSTINIT static const uint qt_meta_data_ZN6enrollE[] = {
...
Q_CONSTINIT const QMetaObject enroll::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6enrollE.offsetsAndSizes,
    qt_meta_data_ZN6enrollE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6enrollE_t,
        // Q_OBJECT / Q_GADGET
...
void *enroll::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6enrollE.stringdata0))
